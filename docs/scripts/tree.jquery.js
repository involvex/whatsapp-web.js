!(function (o) {
    ...
    function (e, t, o) {
        ...
        var r, n;
        ((t.__esModule = !0),
            ((n = r = t.Position || (t.Position = {}))[(n.Before = 1)] =
                "Before"),
            (n[(n.After = 2)] = "After"),
            (n[(n.Inside = 3)] = "Inside"),
            (n[(n.None = 4)] = "None"));
            ...
            return (
                ...
                (n.prototype.getLastChild = function () {
                    if (this.hasChildren()) {
                        ...
                        return e.hasChildren() && e.is_open
                            ? e.getLastChild()
                            : e;
                    }
                    return null;
            ...
            S = (function (e) {
                function t() {
                    ...
                    return (
                        (n._handleClick = function (e) {
                            ...
                            if (t)
                                if ("button" === t.type)
                                    (n.toggle(t.node, n.options.slide),
                                        e.preventDefault(),
                                        e.stopPropagation());
                                else if ("label" === t.type) {
                                    var o = t.node;
                                    n
                                        ._triggerEvent("tree.click", {
                                            node: o,
                                            click_event: e,
                                        })
                                        .isDefaultPrevented() ||
                        ...
                        (n._handleDblclick = function (e) {
                            ...
                            t &&
                                "label" === t.type &&
                                n._triggerEvent("tree.dblclick", {
                                    node: t.node,
                                    click_event: e,
                                });
                        }),
                        (n._handleContextmenu = function (e) {
                            var t = s(e.target).closest(
                            ...
                            if (t.length) {
                                ...
                                if (o)
                                    return (
                                        e.preventDefault(),
                                        e.stopPropagation(),
                                        n._triggerEvent("tree.contextmenu", {
                                            node: o,
                                            click_event: e,
                                        }),
                                        !1
                ...
                return (
                    ...
                    (t.prototype.reload = function (e) {
                        return (
                            this._loadDataFromUrl(null, null, e),
                            this.element
                        );
                    }),
                    ...
                    (t.prototype.closeNode = function (e, t) {
                        ...
                        return (
                            e.isFolder() &&
                                (new _.FolderElement(e, this).close(
                                    o,
                    ...
                    (t.prototype.refreshHitAreas = function () {
                        return (
                            this.dndHandler && this.dndHandler.refresh(),
                            this.element
                        );
                    }),
                    ...
                    (t.prototype.removeNode = function (e) {
                        ...
                        return (
                            t.parent &&
                                this.selectNodeHandler &&
                                (this.selectNodeHandler.removeFromSelection(
                                    t,
                                    !0,
                                ),
                                t.remove(),
                    ...
                    (t.prototype.addToSelection = function (e, t) {
                        ...
                        return (
                            this.selectNodeHandler &&
                                ...
                                this._getNodeElementForNode(o).select(
                                    void 0 === t || t,
                                ),
                                this._saveState()),
                            this.element
                    ...
                    (t.prototype.moveDown = function () {
                        return (
                            this.keyHandler && this.keyHandler.moveDown(),
                            this.element
                        );
                    }),
                    (t.prototype.moveUp = function () {
                        return (
                            this.keyHandler && this.keyHandler.moveUp(),
                            this.element
                        );
                    }),
                    ...
                    (t.prototype.testGenerateHitAreas = function (e) {
                        return this.dndHandler
                            ? ((this.dndHandler.currentItem =
                                  this._getNodeElementForNode(e)),
                    ...
                    (t.prototype._openNode = function (e, t, o) {
                        ...
                        if (e.isFolder())
                            if (e.load_on_demand)
                                this._loadFolderOnDemand(e, t, o);
                            else {
                    ...
                    (t.prototype._getNodeElementForNode = function (e) {
                        return e.isFolder()
                            ? new _.FolderElement(e, this)
                            : new _.NodeElement(e, this);
                    }),
                    ...
                    (t.prototype._getScrollLeft = function () {
                        return (
                            (this.scrollHandler &&
                                this.scrollHandler.getScrollLeft()) ||
                            0
                        );
                    }),
                    (t.prototype._init = function () {
                        (e.prototype._init.call(this),
                            ...
                            null === this.options.closedIcon &&
                                (this.options.closedIcon =
                                    this._getDefaultClosedIcon()),
                            (this.renderer = new d.default(this)),
                            (this.dataLoader = new u.default(this)),
                            null != c.default
                                ? (this.saveStateHandler = new c.default(this))
                                : (this.options.saveState = !1),
                            null != g.default &&
                                (this.selectNodeHandler = new g.default(this)),
                            null != a.DragAndDropHandler
                                ? (this.dndHandler = new a.DragAndDropHandler(
                                      this,
                                  ))
                                : (this.options.dragAndDrop = !1),
                            null != f.default &&
                                (this.scrollHandler = new f.default(this)),
                            null != h.default &&
                                null != g.default &&
                                (this.keyHandler = new h.default(this)),
                            this._initData(),
                    ...
                    (t.prototype._initTree = function (e) {
                        ...
                        (this._refreshElements(null),
                            n ? this._setInitialStateOnDemand(t) : t());
                    }),
                        ...
                        var t = this,
                            e = (function () {
                                if (t.options.saveState && t.saveStateHandler) {
                                    var e =
                                        t.saveStateHandler.getStateFromStorage();
                                    return e
                                        ? [
                                              !0,
                                              t.saveStateHandler.setInitialState(
                                                  e,
                                              ),
                                          ]
                                        : [!1, !1];
                    ...
                    (t.prototype._setInitialStateOnDemand = function (t) {
                        ...
                        (function () {
                            if (s.options.saveState && s.saveStateHandler) {
                                var e =
                                    s.saveStateHandler.getStateFromStorage();
                                return (
                                    !!e &&
                                    (s.saveStateHandler.setInitialStateOnDemand(
                                        e,
                                        t,
                                    ),
                                    !0)
                    ...
                    (t.prototype._getClickTarget = function (e) {
                        ...
                        if (o.length) {
                            if ((n = this._getNode(o)))
                                return { type: "button", node: n };
                        } else {
                            var n,
                                r = t.closest(".jqtree-element");
                            if (r.length && (n = this._getNode(r)))
                                return { type: "label", node: n };
                        }
                        return null;
                    }),
                    ...
                    (t.prototype._selectNode = function (e, t) {
                        ...
                        if (this.selectNodeHandler) {
                            ...
                            if (!e)
                                return (this._deselectCurrentNode(), void r());
                            if (
                                o.options.onCanSelectNode
                                    ? o.options.selectable &&
                                      o.options.onCanSelectNode(e)
                                    : o.options.selectable
                            ) {
                                var i,
                                    s = e;
                    ...
                    (t.prototype._loadData = function (e, t) {
                        e &&
                            ...
                            t
                                ? (this._deselectNodes(t),
                                  this._loadSubtree(e, t))
                                : this._initTree(e),
                            this.isDragging() &&
                                this.dndHandler &&
                    ...
                    (t.prototype._deselectNodes = function (e) {
                        if (this.selectNodeHandler)
                            for (
                                var t = 0,
                                    o =
                                        this.selectNodeHandler.getSelectedNodesUnder(
                                            e,
                                        );
                                t < o.length;
                                t++
                ...
                return (
                    (e.prototype.mouseCapture = function (e) {
                        ...
                        return (
                            o &&
                                ...
                                (this.treeWidget.options.onCanMove(o.node) ||
                                    (o = null)),
                            (this.currentItem = o),
                    ...
                    (e.prototype.mouseStart = function (e) {
                        if (
                            ...
                            var t = l(e.target).offset(),
                                ...
                                i = this.treeWidget.options.autoEscape
                                    ? s.htmlEscape(r.name)
                                    : r.name;
                            return (
                                ...
                                (this.isDragging = !0),
                                (this.positionInfo = e),
                                this.currentItem.$element.addClass(
                                    "jqtree-moving",
                                ),
                                !0
                            );
                    ...
                    (e.prototype.mouseDrag = function (e) {
                        if (
                            ...
                            (this.dragElement.move(e.pageX, e.pageY),
                                (this.positionInfo = e));
                    ...
                    (e.prototype.mouseStop = function (e) {
                        ...
                        return (
                            this.currentItem &&
                                (this.currentItem.$element.removeClass(
                                    "jqtree-moving",
                                ),
                                (this.currentItem = null)),
                            (this.isDragging = !1),
                    ...
                    (e.prototype.refresh = function () {
                        (this.removeHitAreas(),
                            this.currentItem &&
                                ...
                                (this.currentItem =
                                    this.treeWidget._getNodeElementForNode(
                                        this.currentItem.node,
                                    )),
                                this.isDragging &&
                                    this.currentItem.$element.addClass(
                    ...
                    (e.prototype.updateDropHint = function () {
                        if (this.hoveredArea) {
                            ...
                            this.previousGhost = e.addDropHint(
                    ...
                    (e.prototype.moveItem = function (e) {
                        ...
                        if (
                            ...
                            var o = this.currentItem.node,
                                ...
                                i = o.parent;
                            r === a.Position.Inside &&
                                (this.hoveredArea.node.is_open = !0);
                            var s = function () {
            ...
            return (
                ...
                (e.prototype.generateHitAreas = function (e) {
                    for (
                        ...
                        (s.top !== t &&
                            o.length &&
                            (o.length &&
                                this.generateHitAreasForGroup(n, o, t, s.top),
                            (t = s.top),
                            (o = [])),
                            o.push(s));
                    }
                    return (
                        this.generateHitAreasForGroup(n, o, t, this.treeBottom),
                        n
                    );
                }),
                ...
                (e.prototype.handleClosedFolder = function (e, t, o) {
                    ...
                    e === this.currentNode
                        ...
                        : (this.addPosition(e, a.Position.Inside, n),
                          t !== this.currentNode &&
                        ...
                        var i = this,
                            ...
                            a = function (o, e) {
                                var t =
                                    ...
                                    n = null;
                                if (o.element) {
                                    if (!(n = l(o.element)).is(":visible"))
                                        return;
                                    (s && (i.handleFirstNode(o), (s = !1)),
                                        o.hasChildren()
                                            ? o.is_open
                                                ? i.handleOpenFolder(o, n) ||
                                                  (t = !1)
        ...
        var u = (function () {
            function e(e, t, o, n) {
                ((this.offsetX = t),
                    (this.offsetY = o),
                    (this.$element = l(
                        '<span class="jqtree-title jqtree-dragging">' +
                            e +
                            "</span>",
                    )),
                ...
                return (
                    ...
                    (e.prototype.createUl = function (e) {
                        ...
                        e
                            ? ((t = "jqtree-tree"),
                              (o = "tree"),
                              this.treeWidget.options.rtl &&
                                  (t += " jqtree-rtl"))
                            : ((t = ""), (o = "group"));
                        var n = document.createElement("ul");
                        return (
                            (n.className = "jqtree_common " + t),
                    ...
                    (e.prototype.createLi = function (e, t) {
                        var o = Boolean(
                                this.treeWidget.selectNodeHandler &&
                                    this.treeWidget.selectNodeHandler.isNodeSelected(
                                        e,
                                    ),
                            ),
                            n = e.isFolder()
                    ...
                    (e.prototype.escapeIfNecessary = function (e) {
                        return this.treeWidget.options.autoEscape
                            ? a.htmlEscape(e)
                            : e;
                    }),
                    (e.prototype.createButtonElement = function (e) {
                        ...
                        return (
                            (t.innerHTML = e),
                            document.createTextNode(t.innerHTML)
                        );
                    }),
                    e
                );
            ...
            return (
                (e.prototype.loadFromUrl = function (e, t, o) {
                    ...
                    if (e) {
                        ...
                        var i = function () {
                            (n.removeLoadingClass(r),
                                n.notifyLoading(!1, t, r));
                        };
                        this.submitRequest(
                            e,
                            function (e) {
            ...
            return (
                ...
                (o.prototype.isFocusOnTree = function () {
                    ...
                    return Boolean(
                        e &&
                            "SPAN" === e.tagName &&
                            this.treeWidget._containsElement(e),
                    );
                }),
                (o.LEFT = 37),
                (o.UP = 38),
        ...
        var i = (function (e) {
            ...
            return (
                ...
                (t.prototype._deinit = function () {
                    ...
                    (e.off("mousemove.mousewidget"),
                        e.off("mouseup.mousewidget"));
                }),
                    ...
                    return this.isMouseStarted
                        ...
                        : !(!this.mouseDelay || this.isMouseDelayMet) ||
                              (this.mouseDownInfo &&
                                  (this.isMouseStarted =
                                      !1 !==
                                      this._mouseStart(this.mouseDownInfo)),
                              this.isMouseStarted
                                  ? this._mouseDrag(t)
                ...
                return (
                    ...
                    (e.prototype.setInitialState = function (e) {
                        if (e) {
                            ...
                            return (
                                e.open_nodes &&
                                    (t = this._openInitialNodes(e.open_nodes)),
                                e.selected_node &&
                    ...
                    (e.prototype._selectInitialNodes = function (e) {
                        for (var t = 0, o = 0, n = e; o < n.length; o++) {
                            ...
                            i &&
                                ((t += 1),
                                this.treeWidget.selectNodeHandler &&
                                    this.treeWidget.selectNodeHandler.addToSelection(
                                        i,
                                    ));
                        }
                        return 0 !== t;
                            ...
                            for (var e = [], t = 0, o = d; t < o.length; t++) {
                                ...
                                r
                                    ? r.is_loading ||
                                      (r.load_on_demand
                                          ? u(r)
                                          : a.treeWidget._openNode(r, !1, null))
                                    : e.push(n);
                            }
                            ((d = e),
                                a._selectInitialNodes(i) &&
                                    a.treeWidget._refreshElements(null),
                                0 === l && s());
                        }
                        var a = this,
                            l = 0,
                    ...
                    (e.prototype.getKeyName = function () {
                        return "string" ==
                            typeof this.treeWidget.options.saveState
            ...
            return (
                    ...
                    return (
                        (this.$scrollParent
                            ? ((n = 0),
                              ...
                              (o =
                                  ((r = e.offset()) ? r.top : 0) -
                                  this.scrollParentTop) + i)
                            : ((t =
                                  (n = jQuery(window).scrollTop() || 0) +
                                  (jQuery(window).height() || 0)),
                              (o = (r = e.offset()) ? r.top : 0) + i)) <= t &&
                        n <= o
                    );
                }),
                ...
                (e.prototype.initScrollParent = function () {
                    ...
                    var t = (function () {
                        ...
                        for (
                            var t = 0, o = s.treeWidget.$el.parents().get();
                            t < o.length;
                            t++
                        ) {
                            var n = o[t],
                ...
                (e.prototype.handleVerticalScrollingWithScrollParent =
                    function (e) {
                        var t = this.$scrollParent && this.$scrollParent[0];
                        t &&
                            (this.scrollParentTop + t.offsetHeight - e.bottom <
                            20
                                ? ((t.scrollTop += 20),
                ...
                (e.prototype.handleVerticalScrollingWithDocument = function (
                    e,
                ) {
                    var t = jQuery(document).scrollTop() || 0;
                    e.top - t < 20
                        ? jQuery(document).scrollTop(t - 20)
                        : (jQuery(window).height() || 0) - (e.bottom - t) <
                              20 && jQuery(document).scrollTop(t + 20);
                }),
                ...
                (e.prototype.handleHorizontalScrollingWithParent = function (
                    e,
                ) {
                ...
                (e.prototype.handleHorizontalScrollingWithDocument = function (
                    e,
                ) {
                    if (void 0 !== e.pageX && void 0 !== e.pageY) {
                        var t = jQuery(document),
                ...
                return (
                    (e.prototype.init = function (e, t) {
                        ((this.node = e),
                            (this.treeWidget = t),
                            e.element ||
                                (e.element = this.treeWidget.element.get(0)),
                ...
                return (
                    ...
                    (t.prototype.open = function (e, t, o) {
                        ...
                        if (
                            ...
                            if (i) {
                                var s =
                                    this.treeWidget.renderer.openedIconElement.cloneNode(
                                        !0,
                                    );
                                i.appendChild(s);
                            }
                            var a = function () {
                                (n.getLi().removeClass("jqtree-closed"),
                                    ...
                                    e && e(n.node),
                                    n.treeWidget._triggerEvent("tree.open", {
                                        node: n.node,
                                    }));
                            };
                            t
                                ? this.getUl().slideDown(o, a)
                                : (this.getUl().show(), a());
                        }
                    }),
                    (t.prototype.close = function (e, t) {
                        ...
                        if (
                            ...
                            if (r) {
                                var i =
                                    this.treeWidget.renderer.closedIconElement.cloneNode(
                                        !0,
                                    );
                                r.appendChild(i);
                            }
                            var s = function () {
                                (o.getLi().addClass("jqtree-closed"),
                                    ...
                                    o.treeWidget._triggerEvent("tree.close", {
                                        node: o.node,
                                    }));
                            };
                            e
                                ? this.getUl().slideUp(t, s)
                                : (this.getUl().hide(), s());
                        }
                    }),
