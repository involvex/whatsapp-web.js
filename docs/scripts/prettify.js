...
((window.PR_SHOULD_USE_CONTINUATION = !0),
    (function () {
        ...
        function y(c, w) {
            ...
            !(function () {
                for (
                    var e = c.concat(w), n = [], t = {}, r = 0, a = e.length;
                    r < a;
                    ++r
                ) {
                    var s = e[r],
                        l = s[3];
                    if (l)
                        for (var i = l.length; 0 <= --i; ) C[l.charAt(i)] = s;
                    var o = s[1],
                        u = "" + o;
                ...
                (n.push(/[\0-\uffff]/),
                    (S = (function (e) {
                        for (
                            var u = 0, c = !1, n = !1, t = 0, r = e.length;
                            t < r;
                            ++t
                        )
                    ...
                    for (
                        ...
                        if (((s += d.length), c)) {
                            var v = f[1],
                                ...
                                b = y + v.length;
                            f[2] &&
                                (y = (b = d.length - f[2].length) - v.length);
                            var x = p.substring(5);
                            (L(r, t + m, d.substring(0, y), _, a),
                                L(r, t + m + y, v, A(x, v), a),
                                L(r, t + m + b, d.substring(b), _, a));
                        } else a.push(t + m, p);
                    }
                    e.decorations = a;
                };
        ...
        function R(e, n, i) {
                    ...
                    var n,
                        t = (function e(n, t) {
                            ...
                            if (a) {
                                ...
                                s.appendChild(r);
                                for (var i = l; i; i = l)
                                    ((l = i.nextSibling), s.appendChild(i));
                            }
                            return r;
                        })(e.nextSibling, 0);
            ...
            for (
                ...
                (((t = r[a]).className = "L" + ((a + l) % 10)),
                    t.firstChild || t.appendChild(c.createTextNode(" ")),
                    s.appendChild(t));
            e.appendChild(s);
        }
        var w = {};
        ...
        function A(e, n) {
            return (
                (e && w.hasOwnProperty(e)) ||
                    (e = /^\s*</.test(n) ? "default-markup" : "default-code"),
                w[e]
            );
        }
        function $(e) {
                ...
                ((e.sourceCode = r),
                    ...
                    (function (e) {
                        ...
                        var v = e.sourceNode,
                            y = "";
                        v &&
                            ((y = v.style.display), (v.style.display = "none"));
                        try {
                            for (; c < u; ) {
                                o[c];
                                var b,
                                ...
                                if (
                                    ...
                                    (_.replaceChild(N, S),
                                        ...
                                        i < x &&
                                            ...
                                            _.insertBefore(S, N.nextSibling)));
                                }
                                (x <= (i = m) && (c += 2), w <= i && (f += 2));
                            }
                        } finally {
        ...
        function N(y, e) {
            ...
            for (
                var r = [t("pre"), t("code"), t("xmp")], x = [], a = 0;
                a < r.length;
                ++a
            )
            ...
            !(function e() {
                for (
                    var n = T.PR_SHOULD_USE_CONTINUATION
                        ? w.now() + 250
                        : 1 / 0;
                    S < x.length && w.now() < n;
                    S++
        ...
        (S(x, ["default-code"]),
            ...
            S(b({ keywords: u, hashComments: !0, multiLineStrings: !0 }), [
                "bash",
                "bsh",
                "csh",
                "sh",
            ...
            S(b({ keywords: s, cStyleComments: !0, regexLiterals: !0 }), [
                "javascript",
                "js",
                "ts",
                "typescript",
